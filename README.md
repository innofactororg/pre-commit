...
This repo defines Git pre-commit hooks intended for use with [pre-commit](http://pre-commit.com/). The currentlysupported hooks are:
...
```yaml
repos:
  - repo: https://github.com/innofactororg/pre-commit
    rev: <VERSION> # Get the latest from: https://github.com/innofactororg/pre-commit/releases
    hooks:
      - id: terraform-fmt
